var AnimationGetter = {
    ...
    {
        return [
                {func:vue.setupToolTips, params:[{sprite:vue.gator, text:"gatorbot<br>Wants 3 blue flowers."}]},

                {func:vue.say, params:[{character:vue.gator, text:'Can I please just have 3 blue flowers?' },
                                        ...
                                        {character:vue.chopperbot, text:'This code sample has you dancing and picking flowers until you have all the flowers you need...' },
