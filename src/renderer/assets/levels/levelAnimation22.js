var AnimationGetter = {
    ...
    get: function (vue)
    {
        return [{func:vue.say, params:[{character:vue.chopperbot, text:'Hey! Look at all the different flowers!.' },
                                       ...
                                       {character:vue.chopperbot, text:'Like this...<br><code>var flower = inspect(); //You MUST be right by the object in question<br>if(flower.petals == 6){<br> //pick up flower<br>}</code><br>OR<br><code>if(flower.color == "blue"){<br> //pick up flower<br>}</code><br>If the flower has the right property, pick it up.See if you can get the gatorbot what he wants.'}]},
